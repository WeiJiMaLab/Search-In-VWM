function [loglik, Jbar_sz, cost_overall, prob_corr_tot] =  LL_costNEW_clust_pow(mi,setsz,delta_s_col,response,N_samp,params)
...
for N_ind = 1:length(N_set)% 1%:length(N_set)
    ...
    fff = @(Jbarr) Fun_Jbars_optimizeNEW_pow(Jbarr,tau,lambda_alpha,pow,mi,N_samp,N,delta_s);
