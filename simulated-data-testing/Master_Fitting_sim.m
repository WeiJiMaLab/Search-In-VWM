function Master_Fitting_sim(mpr_index)
mi = 1; % 1: VPF; 2: EPF, 3: VP, 4: EP

switch mi
    case 1
        alldata = load('alldata_sim_VPF.mat');
    case 4
...
switch mi
    case 1
        savefilename=['sim_fits_vpf/vpf_sim_model_fits_', num2str(N_samp), 'samp_','sbj_',num2str(par),'_run_',num2str(runi),'.mat'];
    case 2
        savefilename=['sim_fits_epf/epf_sim_model_fits_', num2str(N_samp), 'samp_','sbj_',num2str(par),'_run_',num2str(runi),'.mat'];
    case 3
